#ifndef VISUALIZE_CNN_CONVOLUTION_PROBE_H
#define VISUALIZE_CNN_CONVOLUTION_PROBE_H

#include "ConvolutionalNN.h"
#include "CNNConvolutionProbe.h"
#include "display.h"

template<typename T>
struct VisualizeCNNConvolutionProbe : public Display < T >
{

    ConvolutionalNeuralNetwork < double > * cnn;
    CNNConvolutionProbe < double > * cnn_convolution_probe;
    ...
    VisualizeCNNConvolutionProbe( ConvolutionalNeuralNetwork<T> * p_cnn
                                , CNNConvolutionProbe<T> * p_cnn_convolution_probe
                                , T min_x 
                                , T max_x 
                                , T min_y 
                                , T max_y 
    ...
    {
        cnn = p_cnn;
        cnn_convolution_probe = p_cnn_convolution_probe;
         probe_in_nx = 0;
        probe_out_nx = 0;
         probe_in_ny = 0;
        probe_out_ny = 0;
    ...
    void update ()
    {
        visualize_convolution_probe( cnn
                                   , cnn_convolution_probe
                                   , probe_in_nx
                                   , probe_out_nx
                                   , probe_in_ny
                                   , probe_out_ny
    ...
    void visualize_convolution_probe( ConvolutionalNeuralNetwork<T> * p_cnn
                                    , CNNConvolutionProbe<T> * p_cnn_convolution_probe
                                    , long in_nx 
                                    , long out_nx 
                                    , long in_ny 
                                    ...
                                    )
    {
        ...
        if(p_cnn_convolution_probe == NULL)
        {
            std::cout << "CNN convolution probe is NULL" << std::endl;
            return;
        }
   
        switch ( p_cnn_convolution_probe -> layer_type )
        {

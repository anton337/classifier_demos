...
public:
                    ...
                    ) const 
    {
      ...
      status=1;
      if (x<o1 || x>=o1+n1 || x+nx>o1+n1) {
        std::cout << "error 1" << std::endl;
        status=0;
      }
      if (y<o2 || y>=o2+n2 || y+ny>o2+n2) {
        std::cout << "error 2" << std::endl;
        status=0;
      }
      if (o<o3 || o>=o3+n3 || o+no>o3+n3) {
      ...
      if (status == 1) {
        ...
        std::cout << "x=" << x << " " << o1 << " " << o1+nx << " " << o1+n1 << std::endl;
        std::cout << "y=" << y << " " << o2 << " " << o2+ny << " " << o2+n2 << std::endl;
        std::cout << "z=" << o << " " << o3 << " " << o3+no << " " << o3+n3 << std::endl;
      }
      return status;
    }
